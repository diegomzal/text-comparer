...
export function DiffInput({ original, setOriginal, modified, setModified }: DiffInputProps) {
    return (
        <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6 min-h-0 pb-4">
            <Card className="flex flex-col h-full border-border/60 dark:border-muted/40 bg-card/50">
                ...
                <CardContent className="flex-1 relative min-h-0">
                    <Textarea
                        ...
                        className="h-full w-full resize-none border-0 focus-visible:ring-0 p-4 text-sm font-mono leading-relaxed bg-muted/50 dark:bg-muted/30"
                        value={original}
